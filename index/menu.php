...
/*
	HOTKEYS
*/
$valid_menu_items = json_encode($valid_menu_items, JSON_UNESCAPED_SLASHES);
echo <<<HOTKEYS
...
var gruppe = [70, 68, 75, 76, 83];						// f d k l s
var raekke = [49, 50, 51];							// 1 2 3

var valid_menu_items = $valid_menu_items;
